...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        // Insert new user
        $insert_query = "INSERT INTO user (username, email, password, contact, address) VALUES (?, ?, ?, ?, ?)";
        $insert_stmt = $conn->prepare($insert_query);
        $insert_stmt->bind_param("sssss", $username, $email, $password, $contact, $address);
...
<head>
    ...
    <title>Register | Sips of Serenity</title>
...
<body>
    ...
    <form id="register-form" method="post" action="register.php">
        ...
        <div class="input-row">
            <div class="input-box">
                <textarea id="contact" name="contact" placeholder="Contact" required></textarea>
